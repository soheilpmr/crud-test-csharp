...
{
    public abstract class StorageBusinessService<DomainModel, PrimaryKeyType> : BusinessService<DomainModel>, IStorageBusinessService<DomainModel, PrimaryKeyType>
      ...
      where PrimaryKeyType : struct
    {
        ...
        public abstract Task<IEnumerable<DomainModel>> ItemsAsync();
        ...
        protected void LogAdd(DomainModel DomainModel, string objectDescriptor = "", Exception? ex = null)
        {
            ...
            Log(new EventId(_logBaseID + 1, "Add"), s, DomainModel?.ID.ToString(), logType);
        }
        ...
        protected void LogModify(DomainModel DomainModel, string? objectDescriptor = null, Exception? ex = null)
        {
            LogTypeEnum logType = LogTypeEnum.SuccessLog;
            ...
            Log(new EventId(_logBaseID + 3, "Modify"), s, DomainModel?.ID.ToString(), logType);
        }
